...
" K/I keys for 5 times k/i (faster navigation)
noremap <silent> I 5k
noremap <silent> K 5j
...
inoremap <silent><expr> <TAB>
      ...
      \ coc#refresh()
inoremap <expr><S-TAB> pumvisible() ? "\<C-p>" : "\h<C-h>"
...
" Use leader and h to show documentation in preview window.
